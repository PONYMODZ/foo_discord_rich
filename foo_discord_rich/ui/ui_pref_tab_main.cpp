...
PreferenceTabMain::PreferenceTabMain( PreferenceTabManager* pParent )
    ...
    , largeImageSettings_( config::largeImageSettings,
                           { { ImageSetting::Light, IDC_RADIO_IMG_LIGHT },
                             ...
                             { ImageSetting::Url, IDC_RADIO_IMG_URL },
    ...
    , ddxOptions_( {
          ...
          qwr::ui::CreateUiDdxOption<qwr::ui::UiDdx_RadioRange>( largeImageSettings_, std::initializer_list<int>{ IDC_RADIO_IMG_LIGHT, IDC_RADIO_IMG_DARK, IDC_RADIO_IMG_URL, IDC_RADIO_IMG_DISABLED } ),
